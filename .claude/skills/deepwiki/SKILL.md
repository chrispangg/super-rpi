...
- `bunx -y mcporter call "${MCP_URL}.ask_question" repoName:owner/repo question:"User's questions"`
- e.g. `bunx -y mcporter call "https://mcp.deepwiki.com/mcp.ask_question" repoName:chrispangg/deepagentsdk question:"what is this repo about?"`

## Read wiki structure

- `bunx -y mcporter call "${MCP_URL}.read_wiki_structure" repoName:owner/repo`

## Read wiki contents

- `bunx -y mcporter call "${MCP_URL}.read_wiki_contents" repoName:owner/repo`
