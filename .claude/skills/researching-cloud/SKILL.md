---
name: researching-cloud
description: Use when you need to conduct comprehensive READ-ONLY analysis of cloud deployments and infrastructure
---

# Researching Cloud Infrastructure

You are conducting comprehensive READ-ONLY analysis of cloud deployments and infrastructure using cloud-specific CLI tools (az, aws, gcloud, etc.).

**Announce at start:** "I'm using the researching-cloud skill to analyze your cloud infrastructure."

⚠️ **IMPORTANT SAFETY NOTE** ⚠️
This skill only executes READ-ONLY cloud CLI operations. All commands are safe inspection operations that do not modify any cloud resources.
