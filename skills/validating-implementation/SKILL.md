---
name: validating-implementation
description: Use when you need to validate that an implementation plan was correctly executed, verifying all success criteria
---

# Validating Implementation

You are validating that an implementation plan was correctly executed, verifying all success criteria and identifying any deviations or issues.

**Announce at start:** "I'm using the validating-implementation skill to verify this implementation."
...
3. **Read all ticket documentation** - Read all files in `docs/tickets/TICKET-NAME/` folder:
   ...
   - `test-cases.md` - Test case definitions (if exists - created by the defining-test-cases skill)
...
3. **Spawn parallel research tasks** to discover implementation:
   ...
   - **If test file exists**: Run tests and verify they pass (tests were created by the defining-test-cases skill)
...
- Tests are unchanged from the defining-test-cases skill (tests define requirements)
...
### Next Steps:
- [ ] Run the iterating-implementation skill to address identified issues
...
This validation skill is designed to work in a cycle with the iterating-implementation skill:
...
1. Run validation → Identifies issues, bugs, deviations
2. Run iteration (the iterating-implementation skill) → Fixes issues found
3. Re-run validation → Verifies fixes, finds any remaining issues
...
- Recommend running the iterating-implementation skill to address issues
