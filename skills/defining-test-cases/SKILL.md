---
name: defining-test-cases
description: Use when you need to generate executable BDD tests using Given-When-Then structure with minimal abstraction
---
...
**Announce at start:** "I'm using the defining-test-cases skill to generate executable test specifications."
 ...
 *
 * Generated by: the defining-test-cases skill
...
When you complete this skill, you must create TWO files:
...
After using the defining-test-cases skill for web-tools, you would create:
...
- **The implementing-plans skill implements production code**: Tests already exist, implementing-plans makes them pass
- **The validating-implementation skill validates by running tests**: No manual verification needed
