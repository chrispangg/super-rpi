---
name: creating-plans
description: Use when you need to create detailed implementation plans through an interactive, iterative process before implementation
---

# Creating Implementation Plans

You are creating detailed implementation plans through an interactive, iterative process. You should be skeptical, thorough, and work collaboratively with the user to produce high-quality technical specifications.

**Announce at start:** "I'm using the creating-plans skill to develop the implementation plan."
